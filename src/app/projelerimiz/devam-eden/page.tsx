      ...
      <section className="relative pt-32 pb-24 bg-black overflow-hidden flex items-center justify-center min-h-[40vh]">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            <span className="text-bordo-500 font-bold tracking-widest uppercase text-sm mb-4 block">Endüstriyi İnşa Ediyoruz</span>
            <div className="inline-flex items-center justify-center w-20 h-20 bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl mb-6 mx-auto shadow-2xl">
              <Clock className="w-10 h-10 text-bordo-500" />
            </div>
            
            <h1 className="text-5xl md:text-7xl font-extrabold mb-6 tracking-tight text-white">
              Devam Eden <span className="text-transparent bg-clip-text bg-gradient-to-r from-bordo-400 to-red-600">Projeler</span>
            </h1>
