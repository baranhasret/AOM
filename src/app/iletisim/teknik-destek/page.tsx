        ...
        <section className="relative pt-32 pb-24 bg-black overflow-hidden flex items-center justify-center min-h-[40vh]">
          ...
          <div className="max-w-7xl mx-auto px-6 relative z-10">
            <div className="text-center max-w-4xl mx-auto">
              <span className="text-bordo-500 font-bold tracking-widest uppercase text-sm mb-4 block">Kesintisiz Destek</span>
              ...
              <h1 className="text-5xl md:text-7xl font-extrabold mb-6 tracking-tight text-white">
                Teknik <span className="text-transparent bg-clip-text bg-gradient-to-r from-bordo-400 to-red-600">Destek</span>
              </h1>
