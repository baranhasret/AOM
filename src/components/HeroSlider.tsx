...
export default function HeroSlider() {
  ...
  const slides: Slide[] = [
    ...
    },
    {
      ...
      image: "/images/ikiz-kule-oksijen-jen-img.jpg",
      buttonText: "Detaylı Bilgi",
    ...
    },
    {
      ...
      image: "/images/otomasyon-robotlari-nelerdir-endustriyel-robot-sistemleri.jpg",
      buttonText: "Detaylı Bilgi",
    ...
    },
    {
      ...
      image: "/images/gida-paketleme-ve-ambalaj-kalite-sertifikasyonu.jpg",
      buttonText: "Detaylı Bilgi",
  ...
  return (
    <div className="relative w-full h-screen overflow-hidden bg-gray-900 -mt-0">
      {/* Slides */}
      ...
      <button
        onClick={prevSlide}
        className="group absolute left-6 top-1/2 transform -translate-y-1/2 z-30 w-12 h-12 flex items-center justify-center rounded-full border border-white/20 hover:bg-white/10 hover:border-white/40 transition-all duration-300"
      >
      ...
      <button
        onClick={nextSlide}
        className="group absolute right-6 top-1/2 transform -translate-y-1/2 z-30 w-12 h-12 flex items-center justify-center rounded-full border border-white/20 hover:bg-white/10 hover:border-white/40 transition-all duration-300"
      >
